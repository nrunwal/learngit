...
public class TC_16654 extends Generic {


	static String TC_Name = "TC_16654";
	...
	@Test  
	public static void tc_16654() throws Exception{
		...
		try {
			...
			String testCase = "frameRatio" ;
			String url = "http://ats.macromedia.com/players/TestSuite/Video/testfiles/frameRatio.html";
			String title = "frameRatio";
			...
			WebElement ele = Driver.findElement(By.xpath("//*[@id='frameRatio']/embed"));
