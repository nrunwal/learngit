...
public class TC_16606 extends Generic{

	static String TC_Name = "TC_16606";
	...
	@Test
	public static void tc_16606() throws Exception{

		Screen screen = new Screen();
		try
		{
			
			String testCase = "URLStream_POST_UTF8" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/codePage/URLStream_POST_UTF8.html";
			String title = "URLStream_POST_UTF8";
			...
			actImagePath= getSeleniumSnap(ele, TC_Name, image2);
