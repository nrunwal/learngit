...
public class TC_16519 extends Generic {


	static String TC_Name = "TC_16519";
	...
	@Test  
	public static void tc_16519() throws Exception{

		logger(Report, "TC_16519", "Param_loop");
		...
		try {
			...
			Driver.get("http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/browserHTML/Table/Browser_tables.htm");
			logger(Test,"Loading : http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/browserHTML/Table/Browser_tables.htm","I");

			WebElement ele = Driver.findElement(Web.getWebElement("Div"));

			logger(Test,
					"Loaded : http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/browserHTML/Table/Browser_tables.htm",
					"I");
			...
			for (Pattern pobj1 : pobj) {
				...
				actImagePath = getActualSnapper(screen, TC_Name, x, y, w, h, "TC_16527_" + c);
