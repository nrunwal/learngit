 ...
 * 
 */
public class TC_16758 extends Generic {
	static String TC_Name = "TC_16758";
	...
	@Test
	public  void tc_16758() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "hamlet";
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/FlashPaper/hamlet.html";
			String title = "hamlet.swf";
