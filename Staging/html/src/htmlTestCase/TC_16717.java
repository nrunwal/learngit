...
public class TC_16717 extends Generic{

	static String TC_Name = "TC_16717";
	...
	@Test
	public static void tc_16717() throws Exception{
		...
		try
		{
			...
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/Security/allowDomainChanges/inboundScripting_GP.htm";
			String title = "";
