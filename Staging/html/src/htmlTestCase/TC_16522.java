...
@Test
public class TC_16522 extends Generic {

	static String TC_Name = "TC_16522";
	...
	@Test
	public static void tc_16522() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "SeamlessTabbingDefault7" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/browserHTML/SeamlessTabbing/SeamlessTabbingDefault8.html";
