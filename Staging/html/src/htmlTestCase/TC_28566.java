...
public class TC_28566 extends Generic{

	static String TC_Name = "TC_28566";
	...
	@Test
	public static void tc_28566() throws Exception{

		Screen screen = new Screen();
		try
		{
			
			String testCase = "Context Menu Leaks" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS10AS3/Shipping/html/BugRegression/2527340/ContextMenuLeaks.html";
			String title = "Context Menu Leaks";
			...
			String image1 = "Capture1";
				String actImagePath1 = getSeleniumSnap(ele, TC_Name, image1);
				...
				String actImagePath2 = getSeleniumSnap(ele, TC_Name, image3);
				Thread.sleep(500);
				//imageMatcher(actImagePath1, actImagePath2);
				boolean testPass = new Imagetest().compareSame(actImagePath1, actImagePath2); 
				Assert.assertTrue(testPass, "TestCase Fails");
				logger(Test, "Image Matched Successfully for Image:"+actImagePath1, "I");
