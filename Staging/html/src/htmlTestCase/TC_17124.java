...
public class TC_17124 extends Generic {


	static String TC_Name = "TC_17124";
	...
	@Test  
	public static void tc_17124() throws Exception{
		
		
		try {
			
			
			String testCase = "AS3_Sprite_Bitmap_nonsmoothed.swf" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/AnimationAndRendering/MipmapSupport/QualityTest/AS3_Sprite_Bitmap_nonsmoothed.html";
			String title = "AS3_Sprite_Bitmap_nonsmoothed.swf";
			...
			if(CURRENTBROWSER.contains("edge")){
				ele = Driver.findElement(By.xpath("/html/body/object/embed"));
			}else{
				ele = Driver.findElement(By.xpath("/html/body/object"));
			}
			...
			for (Pattern pobj1 : pobj) {
				...
				match = screen.exists(pobj1.similar(0.6f), wait * c);
