...
public class TC_18322 extends Generic{

	static String TC_Name = "TC_18322";
	...
	@Test
	public static void tc_18322() throws Exception{

		Screen screen = new Screen();
		try
		{
			
			String testCase = "JSObjecttoFlashCallReturn" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/BrowserHTML/JavaScript/JSObject/JSObjecttoFlashCallReturn.html";
			String title = "Call JS Method from Flash via ExternalInterface that returns an object with a space at the beginning and end";
