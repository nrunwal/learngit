...
public class TC_21150 extends Generic{

	static String TC_Name = "TC_21150";
	...
	@Test
	public static void tc_21150() throws Exception{
		...
		try
		{
			...
			String testCase = "" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS10AS3/Shipping/html/CrashTests/MacFlexCrash/f1.html";
			String title = "";
