...
public class TC_44321 extends Generic {
	static String TC_Name = "TC_44321";
	...
	@Test
	public  void tc_44321() throws Exception{
		...
		try
		{
			...
			WebElement ele= Driver.findElement(By.xpath("//*[@id='PolicyRedirectTest']/object"));
