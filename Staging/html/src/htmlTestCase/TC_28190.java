...
public class TC_28190 extends Generic{

	static String TC_Name = "TC_28190";
	...
	@Test
	public static void tc_28190() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "Param_align_right" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/BrowserHTML/Variables/Param/Param_align_right.html";
			String title = "Param_align_right";
