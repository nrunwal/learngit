...
public class TC_28191 extends Generic{

	static String TC_Name = "TC_28191";
	...
	@Test
	public static void tc_28191() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "Param_align_top" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/BrowserHTML/Variables/Param/Param_align_top.html";
			String title = "Param_align_top";
