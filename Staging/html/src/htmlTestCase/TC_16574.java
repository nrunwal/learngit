 ...
 * 
 */
public class TC_16574 extends Generic {
	static String TC_Name = "TC_16574";
	...
	@Test
	public  void tc_16574() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "PrintAPI_XYScale";
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/Printing/PrintJobAPI_XYScale/PrintAPI_XYScale.html";
