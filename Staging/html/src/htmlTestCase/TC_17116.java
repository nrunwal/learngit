...
public class TC_17116 extends Generic{

	static String TC_Name = "TC_17116";
	...
	@Test
	public static void tc_17116() throws Exception{

		Screen screen = new Screen();
		try
		{

			String testCase = "AS2_loadMovie_16bit_smoothed.swf" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/AnimationAndRendering/MipmapSupport/QualityTest/AS2_loadMovie_16bit_smoothed.html";
			String title = "AS2_loadMovie_16bit_smoothed.swf";
