 ...
 * 
 */
public class TC_16759 extends Generic {
	static String TC_Name = "TC_16759";
	...
	@Test
	public  void tc_16759() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "hamlet_tall";
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/FlashPaper/hamlet_tall.html";
			String title = "hamlet_tall.swf";
