 ...
 * 
 */
public class TC_16762 extends Generic {
	static String TC_Name = "TC_16762";
	...
	@Test
	public  void tc_16762() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "paper1";
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/FlashPaper/paper1.html";
			String title = "paper1.swf";
