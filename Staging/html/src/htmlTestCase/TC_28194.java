...
public class TC_28194 extends Generic{

	static String TC_Name = "TC_28194";
	...
	@Test
	public static void tc_28194() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "Param_menu_true" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/BrowserHTML/Variables/Param/Param_menu_true.html";
			String title = "Param_menu_true";
