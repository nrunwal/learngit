...
public class TC_27896 extends Generic{

	static String TC_Name = "TC_27896";
	...
	@Test
	public static void tc_27896() throws Exception{

		Screen screen = new Screen();
		try
		{
			
			String testCase = "stringBug.swf" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS10AS3/Shipping/html/BugRegression/2504228/stringBug.html";
			String title = "stringBug.swf";
