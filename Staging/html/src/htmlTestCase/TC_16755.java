...
public class TC_16755 extends Generic {
	static String TC_Name = "TC_16755";
	...
	@Test
	public  void tc_16755() throws Exception{
		Screen screen = new Screen();
		try
		{
			String testCase = "TextSnapshotTesterGood7 " ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/FlashPaper/TextSnapshotTesterGood7.html";
			String title = "TextSnapshotTesterGood7.swf";
