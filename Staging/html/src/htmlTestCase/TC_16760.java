 ...
 * 
 */
public class TC_16760 extends Generic {
	static String TC_Name = "TC_16760";
	...
	@Test
	public  void tc_16760() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "hamlet_wide";
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/FlashPaper/hamlet_wide.html";
			String title = "hamlet_wide.swf";
