...
public class TC_27937 extends Generic{

	static String TC_Name = "TC_27937";
	...
	@Test
	public static void tc_27937() throws Exception{

		Screen screen = new Screen();
		try
		{
			
			String testCase = "Regression media for bug 2366779" ;
			String url = "https://ats.macromedia.com/Players/ATS/ATS10AS3/Shipping/html/Security/fuzzed/2366779.html";
			String title = "2366779.swf";
			...
			if(CURRENTOS.contains("win") && CURRENTBROWSER.contains("firefox")){
				SettingsManager();
				Thread.sleep(1000);
			}
