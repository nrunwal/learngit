...
public class TC_16543 extends Generic {


	static String TC_Name = "TC_16543";
	...
	@Test  
	public static void tc_16543() throws Exception{
		...
		try {
			...
			String testCase = "Path_ldMovRootPath" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/browserHTML/Variables/Path/RelativePath-basetag/RPathBT_ldMovRootPath.html";
			String title = "Path_ldMovRootPath";
