...
@Test
public class TC_16520 extends Generic {

	static String TC_Name = "TC_16520";
	...
	@Test
	public static void tc_16520() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "SeamlessTabbingTrue7" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/browserHTML/SeamlessTabbing/SeamlessTabbingTrue8.html";
			String title = "SeamlessTabbingTrue7";
