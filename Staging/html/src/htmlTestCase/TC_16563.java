 ...
 * 
 */
public class TC_16563 extends Generic {
	static String TC_Name = "TC_16563";
	...
	@Test
	public  void tc_16563() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "PrintAPI_CursorMask";
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/Printing/PrintJobAPI_Masks/PrintAPI_CursorMask.html";
			String title = "PrintAPI_CursorMask";
