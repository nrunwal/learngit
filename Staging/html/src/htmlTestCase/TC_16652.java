...
public class TC_16652 extends Generic {


	static String TC_Name = "TC_16652";
	...
	@Test  
	public static void tc_16652() throws Exception{
		...
		try {
			...
			String testCase = "KeyframeInterval" ;
			String url = "http://ats.macromedia.com/players/TestSuite/Video/testfiles/KeyframeInterval.html";
			String title = "KeyframeInterval";
			...
			WebElement ele = Driver.findElement(By.xpath("//*[@id='KeyframeInterval']/embed"));
