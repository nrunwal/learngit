...
public class TC_17115 extends Generic{

	static String TC_Name = "TC_17115";
	...
	@Test
	public static void tc_17115() throws Exception{

		Screen screen = new Screen();
		try
		{

			String testCase = "	MipMap Quality Test 1  " ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/AnimationAndRendering/MipmapSupport/QualityTest/AS2_loadMovie_16bit_nonsmoothed.html";
			String title = "AS2_loadMovie_16bit_nonsmoothed.swf";
