...
public class TC_28134 extends Generic{

	static String TC_Name = "TC_28134";
	...
	@Test
	public static void tc_28134() throws Exception{

		Screen screen = new Screen();
		try
		{

			String testCase = "Regression media for bug 2533822 - incorrect URL parsing and domain resolution" ;
			String url = "http://test.playercore10.com/2533822/index.html";
			String title = "Regression media for bug 2533822";
