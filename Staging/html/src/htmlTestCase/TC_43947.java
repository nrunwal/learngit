...
public class TC_43947 extends Generic{

	static String TC_Name = "TC_43947";
	...
	@Test
	public static void tc_43947() throws Exception{
		...
		try
		{
			...
			String url = "http://ats.macromedia.com/Players/ATS/ATS10AS3/Shipping/HTML/Security/BugRegression-HTMLSuite/0days/3111934/ExtInt.html";
			String title = "ExtInt0day";
			...
			try{
				...
				System.out.println("Alert Obtained: "+e);
