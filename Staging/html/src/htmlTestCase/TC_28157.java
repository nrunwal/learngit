...
public class TC_28157 extends Generic{

	static String TC_Name = "TC_28157";
	...
	@Test
	public static void tc_28157() throws Exception{

		Screen screen = new Screen();
		try
		{
			
			String testCase = "registerClassAlias used improperly across domains" ;
			String url = "http://2520145.playercore10.com/2520145.html";
			String title = "2520145";
			...
			objClick(screen, expImage, ele);
			String image5 = "Capture3";
			expImage = imageFinder(image5);
			actImagePath= getSeleniumSnap(ele, TC_Name, image5);
			imageMatcher(expImage, actImagePath);
			Report.endTest(Test);
