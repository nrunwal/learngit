...
public class TC_28192 extends Generic{

	static String TC_Name = "TC_28192";
	...
	@Test
	public static void tc_28192() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "Param_base" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/BrowserHTML/Variables/Param/Param_base.html";
			String title = "Param_base";
