...
public class TC_28653 extends Generic{

	static String TC_Name = "TC_28653";
	...
	@Test
	public static void tc_28653() throws Exception{

		Screen screen = new Screen();
		try
		{

			String testCase = "Blocking local content loading from UNC paths, part 2" ;
			String url = "http://test.playercore10.com/UNCLoad/UNCFrames.htm";
