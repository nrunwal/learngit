...
@Test
public class TC_16531 extends Generic {

	static String TC_Name = "TC_16531";
	...
	@Test
	public static void tc_16531() throws Exception{
		...
		try
		{
			...
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/browserHTML/Variables/Param/Param_qualityHigh.html";
			String title = "Param_high";
			...
			//WebElement ele=Driver.findElement(By.xpath("/html/body/object/embed"));
			logger(Test, "Flash Element Found: "+ele, "I");
			
			
			
			String image1 = "Smooth";
