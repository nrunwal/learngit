...
@Test
public class TC_16779 extends Generic {

	static String TC_Name = "TC_16779";
	...
	@Test
	public static void tc_16779() throws Exception{


		Screen screen = new Screen();
		try
		{
			String testCase = "RPathBT_getUrlAbsPath" ;
			String url = "http://ats.macromedia.com/Players/ATS/ATS9AS2/Shipping/html/browserHTML/Variables/Path/RelativePath-basetag/RPathBT_getUrlAbsPath.html";
			String title = "Path_getUrlAbsPath";
			...
			for(String window: windows){
				...
				if(!mainwind.equals(window)){
					...
					String expectedtext="AbsolutePath - PASS";
