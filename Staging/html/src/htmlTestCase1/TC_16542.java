...
public class TC_16542 extends Generic {

	static String TC_Name = "TC_16542";
	...
	public static void tc_16542() throws IOException, InterruptedException {

		logger(Report, "TC_16542", "RPathBT_ldMovAbsPath");
		...
		try {
			...
			Driver.get(
					"http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/browserHTML/Variables/Path/RelativePath-basetag/RPathBT_ldMovAbsPath.html");
			logger(Test,
					"Loading : http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/browserHTML/Variables/Path/RelativePath-basetag/RPathBT_ldMovAbsPath.html",
					"I");
			Thread.sleep(4000);
			...
			logger(Test,
					"Loaded : http://ats.macromedia.com/Players/ATS/ATS9AS3/Shipping/html/browserHTML/Variables/Path/RelativePath-basetag/RPathBT_ldMovAbsPath.html",
					"I");
			...
			for (Pattern pobj1 : pobj) {
				...
				actImagePath = getActualSnapper(screen, "TC_16542", x, y, w, h, "TC_16542_" + c);
			...
			Assert.assertTrue(c == 6, "TC_16542 failed with  " + (6 - c) + "  failed imageMatches.");
